...
export const paths = {
  ...
  dashboard: {
    ...
    sources: `${ROOTS.DASHBOARD}/sources`,
    accounts: `${ROOTS.DASHBOARD}/accounts`,
    devices: `${ROOTS.DASHBOARD}/devices`,
    devicesMostLogin: `${ROOTS.DASHBOARD}/devices/mostlogin`,
    devicesAndroid: `${ROOTS.DASHBOARD}/devices/android`,
    devicesAdd: `${ROOTS.DASHBOARD}/devices/add`,
    deviceDetails: (id: string) => `${ROOTS.DASHBOARD}/devices/${id}`,
    deviceAccounts: (id: string) => `${ROOTS.DASHBOARD}/devices/${id}/accounts`,
    deviceJobs: (id: string) => `${ROOTS.DASHBOARD}/devices/${id}/jobs`,
    deviceHealthLogs: (id: string) => `${ROOTS.DASHBOARD}/devices/${id}/health-logs`,
    deviceSettings: (id: string) => `${ROOTS.DASHBOARD}/devices/${id}/settings`,
